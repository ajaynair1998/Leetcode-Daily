...
function checkIfIdenticalNodes(nodeOne,nodeTwo)
{
   ...
   if(nodeOne === nodeTwo)
    ...
    return (checkIfIdenticalNodes(nodeOne.left,nodeTwo.left) && 
...
function iterateThroughTheTree(root,subRoot,result)
{
    ...
    return (iterateThroughTheTree(root.left,subRoot,false) || iterateThroughTheTree(root.right,subRoot,false))
